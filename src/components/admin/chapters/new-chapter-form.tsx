...
export const NewChapterForm = ({ seriesId, seriesTitle }: ChapterFormProps) => {
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      try {
        ...
        // Generate upload URLs for all pages
        const uploadUrls = await generateUploadUrl({
          count: selectedFiles.length,
        });

        // Upload all pages with progress tracking
        ...
        toast.success(
          `Chapter ${value.chapterNumber} created with ${selectedFiles.length} pages!`
        );
  ...
  return (
    <Card className="max-w-4xl w-full">
      ...
      <CardContent>
        ...
        >
          <div className="space-y-6">
            ...
            {/* Page Upload Section */}
            <div>
              <h3 className="text-lg font-semibold mb-4">Chapter Pages</h3>
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">
                    {selectedFiles.length} page(s) selected
                  </span>
                </div>
      ...
      <CardFooter className="flex justify-between">
        ...
        <Button type="submit" form="chapter-form" disabled={uploading}>
